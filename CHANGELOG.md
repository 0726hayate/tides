...
### Fixed
- Birth control settings no longer snap back to "None" right after you pick an option. A race between the async database read and your first tap was overwriting the selection on fresh installs.
